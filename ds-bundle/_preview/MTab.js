...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MTab.tsx
  var MTab_exports = {};
  __export(MTab_exports, {
    Basic: () => Basic2
  });
  init_define_import_meta_env();
  var React = __toESM(require_react_shim(), 1);

  // src/atoms/MTab/MTab.stories.tsx
  var MTab_stories_exports = {};
  __export(MTab_stories_exports, {
    Basic: () => Basic,
    default: () => MTab_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MTab
  var ds_MTab_exports = {};
  __export(ds_MTab_exports, {
    default: () => ds_MTab_default
  });
  init_define_import_meta_env();
  __reExport(ds_MTab_exports, __toESM(require_ds_raw()));
  var g = window.WsUikit;
  var ds_MTab_default = g["MTab"] !== void 0 ? g["MTab"] : g;

  // src/atoms/MTab/MTab.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var meta = {
    title: "Atoms/Form/MTab",
    component: ds_MTab_default
  };
  var MTab_stories_default = meta;
  ...
  var Basic2 = (
    /* Basic */
    compose(MTab_stories_exports, "Basic")
  );
  return __toCommonJS(MTab_exports);
})();
