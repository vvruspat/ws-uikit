...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MTabs.tsx
  var MTabs_exports = {};
  __export(MTabs_exports, {
    Basic: () => Basic2
  });
  init_define_import_meta_env();
  var React = __toESM(require_react_shim(), 1);

  // src/atoms/MTabs/MTabs.stories.tsx
  var MTabs_stories_exports = {};
  __export(MTabs_stories_exports, {
    Basic: () => Basic,
    default: () => MTabs_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MTabs
  var ds_MTabs_exports = {};
  __export(ds_MTabs_exports, {
    default: () => ds_MTabs_default
  });
  init_define_import_meta_env();
  __reExport(ds_MTabs_exports, __toESM(require_ds_raw()));
  var g = window.WsUikit;
  var ds_MTabs_default = g["MTabs"] !== void 0 ? g["MTabs"] : g;

  // src/atoms/MTabs/MTabs.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var meta = {
    title: "Atoms/Form/MTabs",
    component: ds_MTabs_default
  };
  var MTabs_stories_default = meta;
  var icon = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MIconBracketsSquare, { mode: "regular", width: 20 });
  var Basic = {
    args: {
      items: [
        {
  ...
  var Basic2 = (
    /* Basic */
    compose(MTabs_stories_exports, "Basic")
  );
  return __toCommonJS(MTabs_exports);
})();
