...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MInput.tsx
  var MInput_exports = {};
  __export(MInput_exports, {
  ...
  // src/atoms/MInput/MInput.stories.tsx
  var MInput_stories_exports = {};
  __export(MInput_stories_exports, {
    AllStatuses: () => AllStatuses,
    Disabled: () => Disabled,
    Invalid: () => Invalid,
    Regular: () => Regular,
    Valid: () => Valid,
    default: () => MInput_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MInput
  var ds_MInput_exports = {};
  __export(ds_MInput_exports, {
    default: () => ds_MInput_default
  });
  init_define_import_meta_env();
  __reExport(ds_MInput_exports, __toESM(require_ds_raw()));
  var g = window.WsUikit;
  var ds_MInput_default = g["MInput"] !== void 0 ? g["MInput"] : g;

  // src/atoms/MInput/MInput.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var meta = {
    title: "Atoms/Form/MInput",
    component: ds_MInput_default
  };
  var MInput_stories_default = meta;
  var argTypes = {
    type: {
      control: { type: "select" },
  ...
  var icon = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MIconBracketsSquare, { mode: "regular", width: 24 });
  var AllStatuses = {
    name: "All Statuses",
    render: () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "24px", maxWidth: 360 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MInput_default, { status: "regular", placeholder: "Placeholder", label: "Regular", before: icon, after: icon }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MInput_default, { status: "valid", placeholder: "Placeholder", label: "Valid", before: icon, after: icon }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MInput_default, { status: "invalid", placeholder: "Placeholder", label: "Invalid", before: icon, after: icon }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MInput_default, { status: "regular", disabled: true, placeholder: "Placeholder", label: "Disabled", before: icon, after: icon })
    ] }),
  ...
  var Regular = {
    args: {
      status: "regular",
      disabled: false,
      before: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MIconBracketsSquare, { mode: "regular", width: 24 }),
      after: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MIconBracketsSquare, { mode: "regular", width: 24 }),
  ...
  var AllStatuses2 = (
    /* All Statuses */
    compose(MInput_stories_exports, "AllStatuses")
  );
  var Regular2 = (
    /* Regular */
    compose(MInput_stories_exports, "Regular")
  );
  var Valid2 = (
    /* Valid */
    compose(MInput_stories_exports, "Valid")
  );
  var Invalid2 = (
    /* Invalid */
    compose(MInput_stories_exports, "Invalid")
  );
  var Disabled2 = (
    /* Disabled */
    compose(MInput_stories_exports, "Disabled")
  );
  return __toCommonJS(MInput_exports);
})();
