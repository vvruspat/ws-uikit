...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MTimepicker.tsx
  var MTimepicker_exports = {};
  __export(MTimepicker_exports, {
    Disabled: () => Disabled2,
    Invalid: () => Invalid2,
    Regular: () => Regular2,
    Valid: () => Valid2
  ...
  // src/atoms/MTimepicker/MTimepicker.stories.tsx
  var MTimepicker_stories_exports = {};
  __export(MTimepicker_stories_exports, {
    Disabled: () => Disabled,
    Invalid: () => Invalid,
    Regular: () => Regular,
    Valid: () => Valid,
    default: () => MTimepicker_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MTimepicker
  var ds_MTimepicker_exports = {};
  __export(ds_MTimepicker_exports, {
    default: () => ds_MTimepicker_default
  });
  init_define_import_meta_env();
  __reExport(ds_MTimepicker_exports, __toESM(require_ds_raw()));
  var g = window.WsUikit;
  var ds_MTimepicker_default = g["MTimepicker"] !== void 0 ? g["MTimepicker"] : g;

  // src/atoms/MTimepicker/MTimepicker.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var meta = {
    title: "Atoms/Form/MTimepicker",
    component: ds_MTimepicker_default
  };
  var MTimepicker_stories_default = meta;
  var argTypes = {
    type: {
      control: {
        type: "select"
  ...
  var Regular2 = (
    /* Regular */
    compose(MTimepicker_stories_exports, "Regular")
  );
  var Valid2 = (
    /* Valid */
    compose(MTimepicker_stories_exports, "Valid")
  );
  var Invalid2 = (
    /* Invalid */
    compose(MTimepicker_stories_exports, "Invalid")
  );
  var Disabled2 = (
    /* Disabled */
    compose(MTimepicker_stories_exports, "Disabled")
  );
  return __toCommonJS(MTimepicker_exports);
})();
