...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MListItem.tsx
  var MListItem_exports = {};
  __export(MListItem_exports, {
    Basic: () => Basic2
  });
  init_define_import_meta_env();
  var React = __toESM(require_react_shim(), 1);

  // src/atoms/MListItem/MListItem.stories.tsx
  var MListItem_stories_exports = {};
  __export(MListItem_stories_exports, {
    Basic: () => Basic,
    default: () => MListItem_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MListItem
  var ds_MListItem_exports = {};
  __export(ds_MListItem_exports, {
    default: () => ds_MListItem_default
  });
  init_define_import_meta_env();
  __reExport(ds_MListItem_exports, __toESM(require_ds_raw()));
  var g3 = window.WsUikit;
  var ds_MListItem_default = g3["MListItem"] !== void 0 ? g3["MListItem"] : g3;

  // src/atoms/MListItem/MListItem.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var meta = {
    title: "Atoms/Form/MListItem",
    component: ds_MListItem_default
  };
  var MListItem_stories_default = meta;
  var item = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(ds_MFlex_default, { gap: "s", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MIconBracketsSquare, { mode: "regular", width: 20 }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MText_default, { children: "List Item" })
  ] });
  var Basic = {
    args: {
      children: item()
  ...
  var Basic2 = (
    /* Basic */
    compose(MListItem_stories_exports, "Basic")
  );
  return __toCommonJS(MListItem_exports);
})();
