...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MFileInput.tsx
  var MFileInput_exports = {};
  __export(MFileInput_exports, {
    Disabled: () => Disabled2,
    Invalid: () => Invalid2,
    Regular: () => Regular2,
    Valid: () => Valid2
  ...
  // src/atoms/MFileInput/MFileInput.stories.tsx
  var MFileInput_stories_exports = {};
  __export(MFileInput_stories_exports, {
    Disabled: () => Disabled,
    Invalid: () => Invalid,
    Regular: () => Regular,
    Valid: () => Valid,
    default: () => MFileInput_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MFileInput
  var ds_MFileInput_exports = {};
  __export(ds_MFileInput_exports, {
    default: () => ds_MFileInput_default
  });
  init_define_import_meta_env();
  __reExport(ds_MFileInput_exports, __toESM(require_ds_raw()));
  var g = window.WsUikit;
  var ds_MFileInput_default = g["MFileInput"] !== void 0 ? g["MFileInput"] : g;
  ...
  var meta = {
    ...
    component: ds_MFileInput_default,
    argTypes,
    args: {
      status: "regular",
      disabled: false,
    ...
    render: ({ accept, multiple, ...rest }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MFileInput_default, { ...rest, fileInputProps: { accept, multiple } })
  };
  var MFileInput_stories_default = meta;
  var Regular = {};
  var Valid = {
    args: {
      status: "valid"
  ...
  var Regular2 = (
    /* Regular */
    compose(MFileInput_stories_exports, "Regular")
  );
  var Valid2 = (
    /* Valid */
    compose(MFileInput_stories_exports, "Valid")
  );
  var Invalid2 = (
    /* Invalid */
    compose(MFileInput_stories_exports, "Invalid")
  );
  var Disabled2 = (
    /* Disabled */
    compose(MFileInput_stories_exports, "Disabled")
  );
  return __toCommonJS(MFileInput_exports);
})();
