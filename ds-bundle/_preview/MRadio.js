...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MRadio.tsx
  var MRadio_exports = {};
  __export(MRadio_exports, {
    Active: () => Active2,
  ...
  // src/atoms/MRadio/MRadio.stories.tsx
  var MRadio_stories_exports = {};
  __export(MRadio_stories_exports, {
    Active: () => Active,
    AllStatuses: () => AllStatuses,
    Disabled: () => Disabled,
    Invalid: () => Invalid,
    Regular: () => Regular,
    default: () => MRadio_stories_default
  });
  init_define_import_meta_env();
  ...
  // ds-shim:ds:MRadio
  var ds_MRadio_exports = {};
  __export(ds_MRadio_exports, {
    default: () => ds_MRadio_default
  });
  init_define_import_meta_env();
  __reExport(ds_MRadio_exports, __toESM(require_ds_raw()));
  var g3 = window.WsUikit;
  var ds_MRadio_default = g3["MRadio"] !== void 0 ? g3["MRadio"] : g3;

  // src/atoms/MRadio/MRadio.stories.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim());
  var meta = {
    title: "Atoms/Form/MRadio",
    component: ds_MRadio_default
  };
  var MRadio_stories_default = meta;
  var descriptionComponentContent = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(ds_MFlex_default, { gap: "s", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MIconBracketsSquare, { mode: "regular", width: 20 }),
  ...
  var AllStatuses = {
    ...
    render: () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MRadio_default, { label: "Regular", description: "Helper text", status: "regular" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MRadio_default, { label: "Active (checked)", description: "Helper text", status: "regular", defaultChecked: true }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MRadio_default, { label: "Invalid", description: "Error message", status: "invalid" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_MRadio_default, { label: "Disabled", description: "Helper text", status: "regular", disabled: true })
    ] }),
  ...
  var AllStatuses2 = (
    /* All Statuses */
    compose(MRadio_stories_exports, "AllStatuses")
  );
  var Regular2 = (
    /* Regular */
    compose(MRadio_stories_exports, "Regular")
  );
  var Active2 = (
    /* Active */
    compose(MRadio_stories_exports, "Active")
  );
  var Invalid2 = (
    /* Invalid */
    compose(MRadio_stories_exports, "Invalid")
  );
  var Disabled2 = (
    /* Disabled */
    compose(MRadio_stories_exports, "Disabled")
  );
  return __toCommonJS(MRadio_exports);
})();
